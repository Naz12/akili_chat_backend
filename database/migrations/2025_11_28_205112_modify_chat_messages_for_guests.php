...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('chat_messages', function (Blueprint $table) {
            ...
            // Recreate foreign key (nullable)
            $table->foreign('user_id')->references('id')->on('users')->onDelete('cascade');
            
            // Add foreign key for guest_session_id
            $table->foreign('guest_session_id')->references('id')->on('guest_sessions')->onDelete('cascade');
            
            // Add index
            $table->index('guest_session_id', 'chat_messages_guest_session_id_index');
        });
    }
    ...
    public function down(): void
    {
        Schema::table('chat_messages', function (Blueprint $table) {
            ...
            $table->dropIndex('chat_messages_guest_session_id_index');
